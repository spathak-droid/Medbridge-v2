    ...
    >
        ...
        <div className="card p-6 sm:p-8">
          ...
          <div className="space-y-4 mb-8">
            <ConsentItem
              ...
              text={
                <>
                  CareArc offers an <strong>AI exercise coach</strong> to
      ...
      {showDeclineConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade-in">
          <div className="absolute inset-0 bg-black/40 backdrop-blur-sm" onClick={() => setShowDeclineConfirm(false)} />
          <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 text-center animate-fade-in-up">
            ...
            <h3 className="text-lg font-bold text-neutral-800 mb-1">Decline AI Coach?</h3>
            <p className="text-sm text-neutral-500 mb-6">
              Without consent, you won't be able to use the AI exercise coach. You'll be signed out.
            </p>
